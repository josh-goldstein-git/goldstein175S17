...
Q. Do "oil and gas " see less effect of Recession?
...
Q. Overall, it seems like income effect dominates. 200 years after
...
more more uncertain (than before the recession) about their
...
```{r}
df <- read.csv("educ_tfr_unemp_by_year.csv")
...
Graded Question 2. Were the less educated hit harder by the recession?
Give your answer in absolute terms (percentage points of unemployment
increase) and in relative terms (e.g, 1.8 times as high in 2010 as
2008)? [ < 50 words]

Graded Question 3. Describe the differences between the time trend in
fertility by education. Is there a difference in levels? Is there a
difference in the time trend other than levels? (Hint: the data for
the more educated is more noisy because it has fewer observations, so
don't take the year-to-year fluctuations too seriously. Instead, look
at the general trend over time.)
...
still unsure if the recovery will last? [ < 50 words]
