...
!!!! (2) modifying note of where ended demo
...
!!!!!!!!!!!!!!!!!! insert the question they need to answer by Friday
                   here.

Go to bcourses and answer the question. say where it is on bCourses.
> I was able to login to the Rstudio 175 cloud server and change my
> password and run a chunk of R

> I was able to login but am having problems and will attend office
> hours to get help as well as consider going to the ...

> I was not able to login to the Rstudio 175 cloud server and will
> contact carlm@... and/or go to the R workshop on Friday at 2 (get
> details) at

> You must go to bCourses to answer this question and have your answer
> recorded.
