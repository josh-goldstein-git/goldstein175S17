...
After the War, fertility began to decline rapidly.
...
If we look at the effects of on the population age-structure, we can
see a very young population in the 1940s, followed by a dramatic drop
in the fraction of the young in the 1970s and 1980s. Since the 1980s,
the smaller birth cohorts have entered the workforce, and the ratio of
the elderly to workers has risen sharply.

From the point of view of population age-structure, is Japan worse off
today than it was right after WWII?

To answer this, let's look at how the age structure has changed.
...
Or we can compare a few snapshots
...
Finally we can compute some summary statistics of the population
age-distribution. We will use the following conventions, where we
define the youth as being aged 0-19, the workers aged 20-64, and
old-age'd as aged 65+.
...
Now we can calculate the dependency ratios and plot.

Here is code for the old-age dependnecy ratio and the youth dependnecy
ratio on the same graph.

```{r}
## code here
```

Add a line for the tdr.
