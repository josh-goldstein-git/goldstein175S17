...
1. Let the production function be Cobb-Douglas, with $y(k)=k^{.4}$.
...
are equal to their marginal product. In our case, we working with per
capita income, so the only variable is the amount of capital per
