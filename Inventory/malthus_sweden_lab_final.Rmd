...
```{r}
tot = 0
source("http://u.demog.berkeley.edu/~josh/tmp2.R")
source("http://u.demog.berkeley.edu/~josh/check_functions.R")
```
...
```{r}
## df <- read.table("SWE_pop_birth_death.txt", header = T)
df <- read.table("http://u.demog.berkeley.edu/~josh/SWE_pop_birth_death.txt",
                  header =T)
