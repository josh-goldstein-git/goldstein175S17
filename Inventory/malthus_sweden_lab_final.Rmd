...
```{r}
tot = 0
source("http://courses.demog.berkeley.edu/goldstein175/Basket/tmp2.R")
...
```{r}
df <- read.table("http://courses.demog.berkeley.edu/goldstein175/Basket/SWE_pop_birth_death.txt",
                 header =T)
