...
tmp <- read.table(file = "../Basket/japan_pop_matrix_1947_2015.txt")
...
tmp <- read.table("../Basket/japan_projection_matrix_2014.txt")
colnames(tmp) <- gsub("X", "", colnames(tmp))
...
print(A.2014[90:96, 90:96]) # towards the lower left corner
```
...
advantage of the schedules that were used by Ron Lee et al. () in
...
df <- read.table("../Basket/japan_nta_schedules.txt")
x <- 0:110
